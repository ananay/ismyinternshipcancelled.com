        ...
        return (
            <div className={"header"}>
                <Helmet>
                    ...
                    {/*<meta property="og:image" content="https://ismyinternshipcancelled.com/img/social-card-img.png" />*/}
                    ...
                    <link rel="shortcut icon" href="https://ismyinternshipcancelled.com/img/huh.png" />
                </Helmet>
                <div className={"menu"}>
                    <ul>
