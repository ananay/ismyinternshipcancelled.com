    ...
    render() {
        ...
        return (
            <div className={"header"}>
                ...
                <div className={"menu"}>
                    <ul>
                        <Link href="/"><li className={current == 'home' ? "active" : ""}>Home</li></Link>
                        <Link href="/2021"><li className={current == '2021' ? "active" : ""}>2021</li></Link>
                        <Link href="/2020"><li className={current == '2020' ? "active" : ""}>2020</li></Link>
                        {/* <Link href="/map"><li className={current == 'map' ? "active" : ""}>Map</li></Link> */}
